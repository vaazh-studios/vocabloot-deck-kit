(function (factory) {
  ...
  var getKClassFromExpression = kotlin_kotlin.$_$.i5;
  ...
  var getKClass = kotlin_kotlin.$_$.j5;
  ...
  var substringBefore = kotlin_kotlin.$_$.d6;
  var removeSuffix = kotlin_kotlin.$_$.y5;
  var substringAfter = kotlin_kotlin.$_$.c6;
  ...
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.x6;
  ...
  var contains_0 = kotlin_kotlin.$_$.f5;
  ...
  var lastIndexOf = kotlin_kotlin.$_$.w5;
  ...
  var indexOf = kotlin_kotlin.$_$.q5;
  var indexOf_0 = kotlin_kotlin.$_$.r5;
  ...
  function Json(configuration, serializersModule) {
    Default_getInstance();
    this.op_1 = configuration;
    this.pp_1 = serializersModule;
    this.qp_1 = new DescriptorSchemaCache();
  }
  protoOf(Json).ff = function () {
    return this.pp_1;
  };
  protoOf(Json).rp = function (serializer, value) {
  ...
  protoOf(Json).sp = function (deserializer, string) {
  ...
  function Json_0(from, builderAction) {
    ...
    var conf = builder.ar();
    return new JsonImpl(conf, builder.zq_1);
  }
  function JsonBuilder(json) {
    this.iq_1 = json.op_1.br_1;
    this.jq_1 = json.op_1.gr_1;
    this.kq_1 = json.op_1.cr_1;
    this.lq_1 = json.op_1.dr_1;
    this.mq_1 = json.op_1.fr_1;
    this.nq_1 = json.op_1.hr_1;
    this.oq_1 = json.op_1.ir_1;
    this.pq_1 = json.op_1.kr_1;
    this.qq_1 = json.op_1.rr_1;
    this.rq_1 = json.op_1.mr_1;
    this.sq_1 = json.op_1.nr_1;
    this.tq_1 = json.op_1.or_1;
    this.uq_1 = json.op_1.pr_1;
    this.vq_1 = json.op_1.qr_1;
    this.wq_1 = json.op_1.lr_1;
    this.xq_1 = json.op_1.er_1;
    this.yq_1 = json.op_1.jr_1;
    this.zq_1 = json.ff();
  }
  protoOf(JsonBuilder).ar = function () {
    if (this.yq_1) {
      ...
      // Inline function 'kotlin.require' call
      if (!this.qq_1.equals(ClassDiscriminatorMode_POLYMORPHIC_getInstance())) {
    ...
    if (!this.mq_1) {
      ...
      // Inline function 'kotlin.require' call
      if (!allWhitespaces) {
        var message_2 = 'Only whitespace, tab, newline and carriage return are allowed as pretty print symbols. Had ' + this.nq_1;
        throw IllegalArgumentException_init_$Create$(toString(message_2));
      }
    }
    return new JsonConfiguration(this.iq_1, this.kq_1, this.lq_1, this.xq_1, this.mq_1, this.jq_1, this.nq_1, this.oq_1, this.yq_1, this.pq_1, this.wq_1, this.rq_1, this.sq_1, this.tq_1, this.uq_1, this.vq_1, this.qq_1);
  };
  function validateConfiguration($this) {
    if (equals($this.ff(), EmptySerializersModule()))
      return Unit_instance;
    var collector = new JsonSerializersModuleValidator($this.op_1);
  ...
  function JsonConfiguration(encodeDefaults, ignoreUnknownKeys, isLenient, allowStructuredMapKeys, prettyPrint, explicitNulls, prettyPrintIndent, coerceInputValues, useArrayPolymorphism, classDiscriminator, allowSpecialFloatingPointValues, useAlternativeNames, namingStrategy, decodeEnumsCaseInsensitive, allowTrailingComma, allowComments, classDiscriminatorMode) {
    ...
    this.br_1 = encodeDefaults;
    this.cr_1 = ignoreUnknownKeys;
    this.dr_1 = isLenient;
    this.er_1 = allowStructuredMapKeys;
    this.fr_1 = prettyPrint;
    this.gr_1 = explicitNulls;
    this.hr_1 = prettyPrintIndent;
    this.ir_1 = coerceInputValues;
    this.jr_1 = useArrayPolymorphism;
    this.kr_1 = classDiscriminator;
    this.lr_1 = allowSpecialFloatingPointValues;
    this.mr_1 = useAlternativeNames;
    this.nr_1 = namingStrategy;
    this.or_1 = decodeEnumsCaseInsensitive;
    this.pr_1 = allowTrailingComma;
    this.qr_1 = allowComments;
    this.rr_1 = classDiscriminatorMode;
  }
  protoOf(JsonConfiguration).toString = function () {
    return 'JsonConfiguration(encodeDefaults=' + this.br_1 + ', ignoreUnknownKeys=' + this.cr_1 + ', isLenient=' + this.dr_1 + ', ' + ('allowStructuredMapKeys=' + this.er_1 + ', prettyPrint=' + this.fr_1 + ', explicitNulls=' + this.gr_1 + ', ') + ("prettyPrintIndent='" + this.hr_1 + "', coerceInputValues=" + this.ir_1 + ', useArrayPolymorphism=' + this.jr_1 + ', ') + ("classDiscriminator='" + this.kr_1 + "', allowSpecialFloatingPointValues=" + this.lr_1 + ', ') + ('useAlternativeNames=' + this.mr_1 + ', namingStrategy=' + toString_0(this.nr_1) + ', decodeEnumsCaseInsensitive=' + this.or_1 + ', ') + ('allowTrailingComma=' + this.pr_1 + ', allowComments=' + this.qr_1 + ', classDiscriminatorMode=' + this.rr_1.toString() + ')');
  };
  ...
  protoOf(JsonObject).equals = function (other) {
    return equals(this.sr_1, other);
  };
  protoOf(JsonObject).hashCode = function () {
    return hashCode(this.sr_1);
  };
  protoOf(JsonObject).toString = function () {
    var tmp = this.sr_1.v1();
    return joinToString(tmp, ',', '{', '}', VOID, VOID, JsonObject$toString$lambda);
  };
  protoOf(JsonObject).o = function () {
    return this.sr_1.o();
  };
  protoOf(JsonObject).tr = function (key) {
    return this.sr_1.q1(key);
  };
  protoOf(JsonObject).q1 = function (key) {
    if (!(!(key == null) ? typeof key === 'string' : false))
      return false;
    return this.tr((!(key == null) ? typeof key === 'string' : false) ? key : THROW_CCE());
  };
  protoOf(JsonObject).ur = function (key) {
    return this.sr_1.s1(key);
  };
  protoOf(JsonObject).s1 = function (key) {
    if (!(!(key == null) ? typeof key === 'string' : false))
      return null;
    return this.ur((!(key == null) ? typeof key === 'string' : false) ? key : THROW_CCE());
  };
  ...
  function JsonLiteral(body, isString, coerceToInlineType) {
    ...
    JsonPrimitive.call(this);
    this.xr_1 = isString;
    this.yr_1 = coerceToInlineType;
    this.zr_1 = toString(body);
    if (!(this.yr_1 == null)) {
      // Inline function 'kotlin.require' call
      // Inline function 'kotlin.require' call
      if (!this.yr_1.ce()) {
  ...
  protoOf(JsonLiteral).wr = function () {
    return this.zr_1;
  };
  ...
  protoOf(JsonLiteral).equals = function (other) {
    ...
    if (!(this.xr_1 === other.xr_1))
      return false;
    if (!(this.zr_1 === other.zr_1))
      return false;
    return true;
  };
  protoOf(JsonLiteral).hashCode = function () {
    var result = getBooleanHashCode(this.xr_1);
    result = imul(31, result) + getStringHashCode(this.zr_1) | 0;
    return result;
  };
  ...
  protoOf(JsonArray).equals = function (other) {
    return equals(this.as_1, other);
  };
  protoOf(JsonArray).hashCode = function () {
    return hashCode(this.as_1);
  };
  protoOf(JsonArray).toString = function () {
    return joinToString(this.as_1, ',', '[', ']');
  };
  protoOf(JsonArray).o = function () {
    return this.as_1.o();
  };
  protoOf(JsonArray).bs = function (element) {
    return this.as_1.k1(element);
  };
  protoOf(JsonArray).k1 = function (element) {
  ...
  protoOf(JsonArray).j = function (index) {
    return this.as_1.j(index);
  };
  protoOf(JsonArray).cs = function (element) {
    return this.as_1.l1(element);
  };
  ...
  protoOf(JsonArray).m1 = function (fromIndex, toIndex) {
    return this.as_1.m1(fromIndex, toIndex);
  };
  ...
  function get_booleanOrNull(_this__u8e3s4) {
    _init_properties_JsonElement_kt__7cbdc2();
    return toBooleanStrictOrNull(_this__u8e3s4.wr());
  }
  function parseLongImpl(_this__u8e3s4) {
    _init_properties_JsonElement_kt__7cbdc2();
    return (new StringJsonLexer(_this__u8e3s4.wr())).ds();
  }
  ...
  protoOf(Composer).js = function () {
    this.fs_1 = false;
  };
  protoOf(Composer).ks = function () {
    return Unit_instance;
  };
  protoOf(Composer).ls = function (v) {
    return this.es_1.ms(v);
  };
  protoOf(Composer).ns = function (v) {
    return this.es_1.os(v);
  };
  protoOf(Composer).ps = function (v) {
    return this.es_1.qs(fromInt(v));
  };
  protoOf(Composer).rs = function (v) {
    return this.es_1.qs(v);
  };
  protoOf(Composer).ss = function (v) {
    return this.es_1.os(v.toString());
  };
  protoOf(Composer).ts = function (value) {
    return this.es_1.us(value);
  };
  function Composer_0(sb, json) {
    return json.op_1.fr_1 ? new ComposerWithPrettyPrint(sb, json) : new Composer(sb);
  }
  ...
  protoOf(ComposerWithPrettyPrint).is = function () {
    ...
    if (inductionVariable < times)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        this.ns(this.xs_1.op_1.hr_1);
      }
       while (inductionVariable < times);
  };
  protoOf(ComposerWithPrettyPrint).js = function () {
    if (this.fs_1)
      this.fs_1 = false;
    else {
      this.is();
  ...
  protoOf(ComposerWithPrettyPrint).ks = function () {
    this.ls(_Char___init__impl__6a9atx(32));
  };
  function readIfAbsent($this, descriptor, index) {
    $this.at_1 = (!descriptor.je(index) && descriptor.ie(index).ud());
    return $this.at_1;
  }
  ...
  function JsonElementMarker(descriptor) {
    var tmp = this;
    tmp.zs_1 = new ElementMarker(descriptor, JsonElementMarker$readIfAbsent$ref(this));
    this.at_1 = false;
  }
  protoOf(JsonElementMarker).bt = function (index) {
    this.zs_1.ci(index);
  };
  protoOf(JsonElementMarker).ct = function () {
    return this.zs_1.di();
  };
  function invalidTrailingComma(_this__u8e3s4, entity) {
    entity = entity === VOID ? 'object' : entity;
    _this__u8e3s4.dt('Trailing comma before the end of JSON ' + entity, _this__u8e3s4.dq_1 - 1 | 0, "Trailing commas are non-complaint JSON and not allowed by default. Use 'allowTrailingComma = true' in 'Json {}' builder to support them.");
  }
  ...
  function namingStrategy(_this__u8e3s4, json) {
    _init_properties_JsonNamesMap_kt__cbbp0k();
    return equals(_this__u8e3s4.be(), CLASS_getInstance()) ? json.op_1.nr_1 : null;
  }
  function deserializationNamesMap(_this__u8e3s4, descriptor) {
    _init_properties_JsonNamesMap_kt__cbbp0k();
    var tmp = get_schemaCache(_this__u8e3s4);
    var tmp_0 = get_JsonDeserializationNamesKey();
    return tmp.ft(descriptor, tmp_0, deserializationNamesMap$lambda(descriptor, _this__u8e3s4));
  }
  function decodeCaseInsensitive(_this__u8e3s4, descriptor) {
    _init_properties_JsonNamesMap_kt__cbbp0k();
    return _this__u8e3s4.op_1.or_1 && equals(descriptor.be(), ENUM_getInstance());
  }
  ...
  function serializationNamesIndices(_this__u8e3s4, json, strategy) {
    ...
    return tmp.ft(_this__u8e3s4, tmp_0, serializationNamesIndices$lambda(_this__u8e3s4, strategy));
  }
  function buildDeserializationNamesMap(_this__u8e3s4, json) {
    ...
    if (inductionVariable < last)
      do {
        ...
        var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.gt_1;
        ...
        if (useLowercaseEnums) {
          ...
          tmp_0 = strategyForClasses.ht(_this__u8e3s4, i, _this__u8e3s4.fe(i));
        } else {
          tmp_0 = null;
        }
        var nameToPut = tmp_0;
  ...
  function serializationNamesIndices$lambda($this_serializationNamesIndices, $strategy) {
    return function () {
      ...
      while (tmp < tmp_0) {
        ...
        tmp_1[tmp_2] = $strategy.ht($this_serializationNamesIndices, tmp_2, baseName);
        tmp = tmp + 1 | 0;
      }
      return tmp_1;
    };
  ...
  function resize($this) {
    var newSize = imul($this.kt_1, 2);
    $this.it_1 = copyOf($this.it_1, newSize);
    $this.jt_1 = copyOf_0($this.jt_1, newSize);
  }
  function JsonPath() {
    var tmp = this;
    // Inline function 'kotlin.arrayOfNulls' call
  ...
  protoOf(JsonPath).lt = function (sd) {
    this.kt_1 = this.kt_1 + 1 | 0;
    var depth = this.kt_1;
    if (depth === this.it_1.length) {
      resize(this);
    }
    this.it_1[depth] = sd;
  };
  protoOf(JsonPath).mt = function (index) {
    this.jt_1[this.kt_1] = index;
  };
  protoOf(JsonPath).nt = function (key) {
    var tmp;
    if (!(this.jt_1[this.kt_1] === -2)) {
      this.kt_1 = this.kt_1 + 1 | 0;
      tmp = this.kt_1 === this.it_1.length;
    } else {
      tmp = false;
    }
    if (tmp) {
    ...
    this.it_1[this.kt_1] = key;
    this.jt_1[this.kt_1] = -2;
  };
  protoOf(JsonPath).ot = function () {
    if (this.jt_1[this.kt_1] === -2) {
      this.it_1[this.kt_1] = Tombstone_instance;
    }
  };
  protoOf(JsonPath).pt = function () {
    var depth = this.kt_1;
    if (this.jt_1[depth] === -2) {
      this.jt_1[depth] = -1;
      this.kt_1 = this.kt_1 - 1 | 0;
    }
    if (!(this.kt_1 === -1)) {
  ...
  protoOf(JsonPath).qt = function () {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder_init_$Create$();
    this_0.j6('$');
    // Inline function 'kotlin.repeat' call
    var times = this.kt_1 + 1 | 0;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var element = this.it_1[index];
        if (!(element == null) ? isInterface(element, SerialDescriptor) : false) {
          if (equals(element.be(), LIST_getInstance())) {
            if (!(this.jt_1[index] === -1)) {
              this_0.j6('[');
              this_0.h9(this.jt_1[index]);
              this_0.j6(']');
            }
          } else {
            var idx = this.jt_1[index];
            if (idx >= 0) {
              this_0.j6('.');
  ...
  function JsonSerializersModuleValidator(configuration) {
    this.rt_1 = configuration.kr_1;
    this.st_1 = configuration.jr_1;
    this.tt_1 = !configuration.rr_1.equals(ClassDiscriminatorMode_NONE_getInstance());
  }
  ...
  function readObject($this) {
    ...
    var lastToken = $this.du_1.hu(6);
    if ($this.du_1.ju() === 4) {
      $this.du_1.iu('Unexpected leading comma');
    }
    // Inline function 'kotlin.collections.linkedMapOf' call
    var result = LinkedHashMap_init_$Create$();
    $l$loop: while ($this.du_1.ku()) {
      var key = $this.eu_1 ? $this.du_1.mu() : $this.du_1.lu();
      $this.du_1.hu(5);
      var element = $this.nu();
      // Inline function 'kotlin.collections.set' call
      result.w1(key, element);
      lastToken = $this.du_1.ou();
      var tmp0_subject = lastToken;
      if (tmp0_subject !== 4)
        if (tmp0_subject === 7)
          break $l$loop;
        else {
          $this.du_1.iu('Expected end of the object or comma');
        }
    }
    if (lastToken === 6) {
      $this.du_1.hu(7);
      ...
      if (!$this.fu_1) {
        invalidTrailingComma($this.du_1);
      }
      $this.du_1.hu(7);
    }
  ...
  function readArray($this) {
    ...
    while ($this.du_1.ku()) {
      ...
      if (!(lastToken === 4)) {
        ...
        var position = tmp0.dq_1;
        if (!condition) {
          var tmp$ret$2 = 'Expected end of the array or comma';
          tmp0.iu(tmp$ret$2, position);
        }
      }
    }
    if (lastToken === 8) {
      ...
      if (!$this.fu_1) {
        invalidTrailingComma($this.du_1, 'array');
      }
      $this.du_1.hu(9);
    }
  ...
  protoOf(JsonTreeReader$readDeepRecursive$slambda).pv = function ($this$DeepRecursiveFunction, it, $completion) {
    var tmp = this.qv($this$DeepRecursiveFunction, it, $completion);
    tmp.e7_1 = Unit_instance;
    tmp.f7_1 = null;
    return tmp.k7();
  };
  protoOf(JsonTreeReader$readDeepRecursive$slambda).q7 = function (p1, p2, $completion) {
    ...
    return this.pv(tmp, p2 instanceof Unit ? p2 : THROW_CCE(), $completion);
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.d7_1 = 3;
            var tmp0_subject = this.lv_1.du_1.ju();
            if (tmp0_subject === 1) {
              this.ov_1 = readValue(this.lv_1, true);
              this.c7_1 = 2;
              continue $sm;
            } else {
              if (tmp0_subject === 0) {
                this.ov_1 = readValue(this.lv_1, false);
                this.c7_1 = 2;
                continue $sm;
              } else {
                if (tmp0_subject === 6) {
                  this.c7_1 = 1;
                  suspendResult = readObject_0(this.lv_1, this.mv_1, this);
                  ...
                  if (tmp0_subject === 8) {
                    this.ov_1 = readArray(this.lv_1);
                    this.c7_1 = 2;
                    continue $sm;
                  } else {
                    var tmp_0 = this;
                    this.lv_1.du_1.iu("Can't begin reading element, unexpected token");
                  }
                }
              }
            }
  ...
  protoOf(JsonTreeReader$readDeepRecursive$slambda).qv = function ($this$DeepRecursiveFunction, it, completion) {
    var i = new JsonTreeReader$readDeepRecursive$slambda(this.lv_1, completion);
    i.mv_1 = $this$DeepRecursiveFunction;
    i.nv_1 = it;
    return i;
  };
  function JsonTreeReader$readDeepRecursive$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$DeepRecursiveFunction, it, $completion) {
      return i.pv($this$DeepRecursiveFunction, it, $completion);
    };
    l.$arity = 2;
    return l;
  }
  function $readObjectCOROUTINE$(_this__u8e3s4, _this__u8e3s4_0, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.xu_1 = _this__u8e3s4;
    this.yu_1 = _this__u8e3s4_0;
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.d7_1 = 5;
            this.av_1 = this.xu_1;
            this.bv_1 = this.av_1.du_1.hu(6);
            if (this.av_1.du_1.ju() === 4) {
              this.av_1.du_1.iu('Unexpected leading comma');
            }

            var tmp_0 = this;
            tmp_0.zu_1 = LinkedHashMap_init_$Create$();
            this.c7_1 = 1;
            continue $sm;
          case 1:
            if (!this.av_1.du_1.ku()) {
              this.c7_1 = 4;
              continue $sm;
            }

            this.cv_1 = this.av_1.eu_1 ? this.av_1.du_1.mu() : this.av_1.du_1.lu();
            this.av_1.du_1.hu(5);
            this.c7_1 = 2;
            suspendResult = this.yu_1.vc(Unit_instance, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            var key = this.cv_1;
            tmp0.w1(key, element);
            this.bv_1 = this.av_1.du_1.ou();
            var tmp0_subject = this.bv_1;
            if (tmp0_subject === 4) {
              this.c7_1 = 3;
              continue $sm;
            } else {
              if (tmp0_subject === 7) {
                ...
                this.av_1.du_1.iu('Expected end of the object or comma');
              }
            }
          ...
          case 4:
            if (this.bv_1 === 6) {
              ...
              if (!this.av_1.fu_1) {
                invalidTrailingComma(this.av_1.du_1);
              }
              this.av_1.du_1.hu(7);
            }

            return new JsonObject(this.zu_1);
          case 5:
            throw this.f7_1;
        }
      } catch ($p) {
  ...
  function JsonTreeReader(configuration, lexer) {
    this.du_1 = lexer;
    this.eu_1 = configuration.dr_1;
    this.fu_1 = configuration.pr_1;
    this.gu_1 = 0;
  }
  protoOf(JsonTreeReader).nu = function () {
    var token = this.du_1.ju();
    var tmp;
    if (token === 1) {
      ...
      this.du_1.iu('Cannot read Json element because of unexpected ' + tokenDescription(token));
    }
    return tmp;
  };
  function classDiscriminator(_this__u8e3s4, json) {
    ...
    while (_iterator__ex2g4s.h()) {
      ...
      if (annotation instanceof JsonClassDiscriminator)
        return annotation.rv_1;
    }
    return json.op_1.kr_1;
  }
  ...
  function DescriptorSchemaCache() {
    this.et_1 = createMapForCache(16);
  }
  protoOf(DescriptorSchemaCache).sv = function (descriptor, key, value) {
    // Inline function 'kotlin.collections.getOrPut' call
    var this_0 = this.et_1;
  ...
  protoOf(DescriptorSchemaCache).ft = function (descriptor, key, defaultValue) {
    var tmp0_safe_receiver = this.tv(descriptor, key);
    ...
    this.sv(descriptor, key, value);
    return value;
  };
  protoOf(DescriptorSchemaCache).tv = function (descriptor, key) {
    var tmp0_safe_receiver = this.et_1.s1(descriptor);
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  function DiscriminatorHolder(discriminatorToSkip) {
    this.uv_1 = discriminatorToSkip;
  }
  function trySkip($this, $receiver, unknownKey) {
    if ($receiver == null)
      return false;
    if ($receiver.uv_1 === unknownKey) {
      $receiver.uv_1 = null;
      return true;
    }
    return false;
  ...
  function checkLeadingComma($this) {
    if ($this.xp_1.ju() === 4) {
      $this.xp_1.iu('Unexpected leading comma');
    }
  }
  function decodeMapIndex($this) {
    var hasComma = false;
    var decodingKey = !(($this.zp_1 % 2 | 0) === 0);
    if (decodingKey) {
      if (!($this.zp_1 === -1)) {
        hasComma = $this.xp_1.wv();
      }
    } else {
      $this.xp_1.vv(_Char___init__impl__6a9atx(58));
    }
    var tmp;
    if ($this.xp_1.ku()) {
      if (decodingKey) {
        if ($this.zp_1 === -1) {
          ...
          if (!condition) {
            ...
            tmp0.iu(tmp$ret$1, position);
          }
        } else {
          var tmp0_0 = $this.xp_1;
          // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.require' call
          var condition_0 = hasComma;
          var position_0 = tmp0_0.dq_1;
          if (!condition_0) {
            var tmp$ret$3 = 'Expected comma after the key-value pair';
            tmp0_0.iu(tmp$ret$3, position_0);
          }
        }
      }
      ...
      if (hasComma && !$this.vp_1.op_1.pr_1) {
        invalidTrailingComma($this.xp_1);
      }
      tmp = -1;
    }
    return tmp;
  ...
  function coerceInputValue($this, descriptor, index) {
    ...
    $l$block_2: {
      ...
      if (equals(elementDescriptor.be(), ENUM_getInstance())) {
        ...
        var tmp0_elvis_lhs = $this.xp_1.yv($this.bq_1.dr_1);
        var tmp_1;
        if (tmp0_elvis_lhs == null) {
          tmp$ret$0 = false;
          break $l$block_2;
        ...
        var coerceToNull = !tmp0.op_1.gr_1 && elementDescriptor.ud();
  ...
  function decodeObjectIndex($this, descriptor) {
    var hasComma = $this.xp_1.wv();
    while ($this.xp_1.ku()) {
      hasComma = false;
      var key = decodeStringKey($this);
      $this.xp_1.vv(_Char___init__impl__6a9atx(58));
      var index = getJsonNameIndex(descriptor, $this.vp_1, key);
      var tmp;
      if (!(index === -3)) {
        var tmp_0;
        if ($this.bq_1.ir_1 && coerceInputValue($this, descriptor, index)) {
          hasComma = $this.xp_1.wv();
          tmp_0 = false;
        } else {
    ...
    var tmp2_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.ct();
    return tmp2_elvis_lhs == null ? -1 : tmp2_elvis_lhs;
  }
  function handleUnknown($this, descriptor, key) {
    if (ignoreUnknownKeys(descriptor, $this.vp_1) || trySkip($this, $this.aq_1, key)) {
      $this.xp_1.aw($this.bq_1.dr_1);
    } else {
      $this.xp_1.eq_1.pt();
      $this.xp_1.zv(key);
    }
  ...
  function decodeListIndex($this) {
    ...
    var tmp;
    if ($this.xp_1.ku()) {
      if (!($this.zp_1 === -1) && !hasComma) {
        $this.xp_1.iu('Expected end of the array or comma');
      }
      $this.zp_1 = $this.zp_1 + 1 | 0;
      tmp = $this.zp_1;
    } else {
      if (hasComma && !$this.vp_1.op_1.pr_1) {
        invalidTrailingComma($this.xp_1, 'array');
      }
      tmp = -1;
    }
    return tmp;
  ...
  function StreamingJsonDecoder(json, mode, lexer, descriptor, discriminatorHolder) {
    ...
    this.wp_1 = mode;
    this.xp_1 = lexer;
    this.yp_1 = this.vp_1.ff();
    this.zp_1 = -1;
    this.aq_1 = discriminatorHolder;
    this.bq_1 = this.vp_1.op_1;
    this.cq_1 = this.bq_1.gr_1 ? null : new JsonElementMarker(descriptor);
  }
  ...
  protoOf(StreamingJsonDecoder).ew = function () {
    return (new JsonTreeReader(this.vp_1.op_1, this.xp_1)).nu();
  };
  protoOf(StreamingJsonDecoder).ve = function (deserializer) {
    try {
      ...
      if (!(deserializer instanceof AbstractPolymorphicSerializer)) {
        ...
        tmp = this.vp_1.op_1.jr_1;
      }
      if (tmp) {
        return deserializer.od(this);
      }
      var discriminator = classDiscriminator(deserializer.md(), this.vp_1);
      var tmp0_elvis_lhs = this.xp_1.fw(discriminator, this.bq_1.dr_1);
      var tmp_0;
      if (tmp0_elvis_lhs == null) {
        ...
        $l$block: {
          ...
          if (!(tmp2 instanceof AbstractPolymorphicSerializer)) {
            ...
            tmp_1 = this.dw().op_1.jr_1;
          }
          if (tmp_1) {
            tmp$ret$0 = tmp2.od(this);
            break $l$block;
          }
          var discriminator_0 = classDiscriminator(tmp2.md(), this.dw());
          var tmp0 = this.ew();
          ...
          if (!(tmp0 instanceof JsonObject)) {
            ...
            var tmp$ret$2 = this.xp_1.eq_1.qt();
          ...
          var jsonTree = tmp0;
          var tmp0_safe_receiver = jsonTree.ur(discriminator_0);
          ...
          tmp$ret$0 = readPolymorphicJson(this.dw(), discriminator_0, jsonTree, actualSerializer);
        }
        return tmp$ret$0;
      } else {
      ...
      try {
        ...
        if ($p instanceof SerializationException) {
          ...
          this.xp_1.iu(message, VOID, hint);
        } else {
          throw $p;
        }
        tmp_7 = tmp_8;
      ...
      this.aq_1 = new DiscriminatorHolder(discriminator);
      ...
      if ($p instanceof MissingFieldException) {
        ...
        if (contains(ensureNotNull(e.message), 'at path'))
          throw e;
        throw new MissingFieldException(e.td_1, plus(e.message, ' at path: ') + this.xp_1.eq_1.qt(), e);
      } else {
        throw $p;
      }
    }
  ...
  protoOf(StreamingJsonDecoder).we = function (descriptor) {
    var newMode = switchMode(this.vp_1, descriptor);
    this.xp_1.eq_1.lt(descriptor);
    this.xp_1.vv(newMode.iw_1);
    ...
    switch (newMode.y1_1) {
      ...
      case 2:
      case 3:
        tmp = new StreamingJsonDecoder(this.vp_1, newMode, this.xp_1, descriptor, this.aq_1);
        break;
      default:
        var tmp_0;
        if (this.wp_1.equals(newMode) && this.vp_1.op_1.gr_1) {
          tmp_0 = this;
        } else {
          tmp_0 = new StreamingJsonDecoder(this.vp_1, newMode, this.xp_1, descriptor, this.aq_1);
        }
  ...
  protoOf(StreamingJsonDecoder).xe = function (descriptor) {
    if (descriptor.de() === 0 && ignoreUnknownKeys(descriptor, this.vp_1)) {
      skipLeftoverElements(this, descriptor);
    }
    if (this.xp_1.wv() && !this.vp_1.op_1.pr_1) {
      invalidTrailingComma(this.xp_1, '');
    }
    this.xp_1.vv(this.wp_1.jw_1);
    this.xp_1.eq_1.pt();
  };
  protoOf(StreamingJsonDecoder).oe = function () {
    var tmp;
    var tmp0_safe_receiver = this.cq_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.at_1;
  ...
  protoOf(StreamingJsonDecoder).hf = function (descriptor) {
    ...
    if (!this.wp_1.equals(WriteMode_MAP_getInstance())) {
      this.xp_1.eq_1.mt(index);
    }
    return index;
  };
  ...
  protoOf(StreamingJsonDecoder).re = function () {
    var value = this.xp_1.mw();
    if (!equalsLong(value, fromInt(convertToInt(value)))) {
      this.xp_1.iu("Failed to parse int for input '" + value.toString() + "'");
    }
  ...
  function encodeTypeInfo($this, discriminator, serialName) {
    ...
    $this.ut_1.ls(_Char___init__impl__6a9atx(58));
    $this.ut_1.ks();
    $this.pf(serialName);
  }
  function StreamingJsonEncoder(composer, json, mode, modeReuseCache) {
    ...
    this.vt_1 = json;
    this.wt_1 = mode;
    this.xt_1 = modeReuseCache;
    this.yt_1 = this.vt_1.ff();
    this.zt_1 = this.vt_1.op_1;
    this.au_1 = false;
    this.bu_1 = null;
    this.cu_1 = null;
    var i = this.wt_1.y1_1;
    if (!(this.xt_1 == null)) {
      if (!(this.xt_1[i] === null) || !(this.xt_1[i] === this)) {
        this.xt_1[i] = this;
      }
    }
  }
  protoOf(StreamingJsonEncoder).dw = function () {
    return this.vt_1;
  };
  ...
  protoOf(StreamingJsonEncoder).vf = function (serializer, value) {
    $l$block: {
      ...
      if (isPolymorphicSerializer) {
        tmp = !this.dw().op_1.rr_1.equals(ClassDiscriminatorMode_NONE_getInstance());
      } else {
        var tmp_0;
        switch (this.dw().op_1.rr_1.y1_1) {
          case 0:
          case 2:
            tmp_0 = false;
            break;
      ...
      var baseClassDiscriminator = needDiscriminator ? classDiscriminator(serializer.md(), this.dw()) : null;
      var tmp_1;
      if (isPolymorphicSerializer) {
      ...
      if (!(baseClassDiscriminator == null)) {
        ...
        this.bu_1 = baseClassDiscriminator;
  ...
  protoOf(StreamingJsonEncoder).we = function (descriptor) {
    var newMode = switchMode(this.vt_1, descriptor);
    if (!(newMode.iw_1 === _Char___init__impl__6a9atx(0))) {
      this.ut_1.ls(newMode.iw_1);
      this.ut_1.gs();
    }
    var discriminator = this.bu_1;
    if (!(discriminator == null)) {
      var tmp0_elvis_lhs = this.cu_1;
      encodeTypeInfo(this, discriminator, tmp0_elvis_lhs == null ? descriptor.ae() : tmp0_elvis_lhs);
      this.bu_1 = null;
      this.cu_1 = null;
    }
    if (this.wt_1.equals(newMode)) {
      return this;
    }
    var tmp1_safe_receiver = this.xt_1;
    var tmp2_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver[newMode.y1_1];
    return tmp2_elvis_lhs == null ? new StreamingJsonEncoder(this.ut_1, this.vt_1, newMode, this.xt_1) : tmp2_elvis_lhs;
  };
  protoOf(StreamingJsonEncoder).xe = function (descriptor) {
    if (!(this.wt_1.jw_1 === _Char___init__impl__6a9atx(0))) {
      this.ut_1.hs();
      this.ut_1.js();
      this.ut_1.ls(this.wt_1.jw_1);
    }
  };
  protoOf(StreamingJsonEncoder).jf = function (descriptor, index) {
    switch (this.wt_1.y1_1) {
      case 1:
        if (!this.ut_1.fs_1) {
          this.ut_1.ls(_Char___init__impl__6a9atx(44));
        }
      ...
      default:
        ...
        this.ut_1.is();
        this.pf(getJsonElementName(descriptor, this.vt_1, index));
        this.ut_1.ls(_Char___init__impl__6a9atx(58));
        this.ut_1.ks();
        break;
    }
  ...
  function unparsedPrimitive($this, literal, primitive, tag) {
    ...
    throw JsonDecodingException_0(-1, "Failed to parse literal '" + literal.toString() + "' as " + type + ' value at element: ' + $this.tw(tag), toString($this.uw()));
  }
  function AbstractJsonTreeDecoder(json, value, polymorphicDiscriminator) {
    ...
    this.pw_1 = json;
    this.qw_1 = value;
    this.rw_1 = polymorphicDiscriminator;
    this.sw_1 = this.dw().op_1;
  }
  ...
  protoOf(AbstractJsonTreeDecoder).uw = function () {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      // Inline function 'kotlin.let' call
      tmp = this.vw(tmp0_safe_receiver);
    }
    var tmp1_elvis_lhs = tmp;
    return tmp1_elvis_lhs == null ? this.p1() : tmp1_elvis_lhs;
  };
  protoOf(AbstractJsonTreeDecoder).tw = function (currentTag) {
    return this.ek() + ('.' + currentTag);
  };
  protoOf(AbstractJsonTreeDecoder).ew = function () {
    return this.uw();
  };
  protoOf(AbstractJsonTreeDecoder).ve = function (deserializer) {
    ...
    $l$block: {
      ...
      if (!(deserializer instanceof AbstractPolymorphicSerializer)) {
        ...
        tmp = this.dw().op_1.jr_1;
      }
      if (tmp) {
        tmp$ret$0 = deserializer.od(this);
        break $l$block;
      }
      var discriminator = classDiscriminator(deserializer.md(), this.dw());
      var tmp0 = this.ew();
      // Inline function 'kotlinx.serialization.json.internal.cast' call
      ...
      var jsonTree = tmp0;
      var tmp0_safe_receiver = jsonTree.ur(discriminator);
      var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : get_jsonPrimitive(tmp0_safe_receiver);
      var type = tmp1_safe_receiver == null ? null : get_contentOrNull(tmp1_safe_receiver);
      var tmp_2;
      try {
      ...
      tmp$ret$0 = readPolymorphicJson(this.dw(), discriminator, jsonTree, actualSerializer);
    }
    return tmp$ret$0;
  };
  ...
  protoOf(AbstractJsonTreeDecoder).we = function (descriptor) {
    ...
    if (tmp_0) {
      ...
      if (equals(tmp0_subject, MAP_getInstance())) {
        ...
        tmp = new JsonTreeDecoder(tmp_12, currentObject, this.rw_1);
      }
    }
    return tmp;
  };
  ...
  protoOf(AbstractJsonTreeDecoder).ww = function (tag) {
    return !(this.vw(tag) === JsonNull_getInstance());
  };
  ...
  protoOf(AbstractJsonTreeDecoder).ik = function (tag) {
    return this.yw((!(tag == null) ? typeof tag === 'string' : false) ? tag : THROW_CCE());
  };
  ...
  protoOf(AbstractJsonTreeDecoder).jk = function (tag) {
    return this.zw((!(tag == null) ? typeof tag === 'string' : false) ? tag : THROW_CCE());
  };
  protoOf(AbstractJsonTreeDecoder).ax = function (tag) {
    ...
    if (!(value_0 instanceof JsonLiteral))
      throw JsonDecodingException_0(-1, "Expected string value for a non-null key '" + tag + "', got null literal instead at element: " + this.tw(tag), toString(this.uw()));
    if (!value_0.xr_1 && !this.dw().op_1.dr_1) {
      throw JsonDecodingException_0(-1, "String literal for key '" + tag + "' should be quoted at element: " + this.tw(tag) + ".\nUse 'isLenient = true' in 'Json {}' builder to accept non-compliant JSON.", toString(this.uw()));
    }
    return value_0.zr_1;
  };
  protoOf(AbstractJsonTreeDecoder).kk = function (tag) {
    return this.ax((!(tag == null) ? typeof tag === 'string' : false) ? tag : THROW_CCE());
  };
  function setForceNull($this, descriptor, index) {
    $this.kx_1 = (!$this.dw().op_1.gr_1 && !descriptor.je(index) && descriptor.ie(index).ud());
    return $this.kx_1;
  }
  ...
  protoOf(JsonTreeDecoder).oe = function () {
    return !this.kx_1 && protoOf(AbstractJsonTreeDecoder).oe.call(this);
  };
  protoOf(JsonTreeDecoder).yj = function (descriptor, index) {
    var strategy = namingStrategy(descriptor, this.dw());
    ...
    var deserializationNamesMap_0 = deserializationNamesMap(this.dw(), descriptor);
    ...
    var fallbackName = strategy == null ? null : strategy.ht(descriptor, index, baseName);
    return fallbackName == null ? baseName : fallbackName;
  };
  protoOf(JsonTreeDecoder).vw = function (tag) {
    return getValue(this.p1(), tag);
  };
  protoOf(JsonTreeDecoder).lx = function (tag) {
    return this.p1().ur(tag);
  };
  protoOf(JsonTreeDecoder).we = function (descriptor) {
    if (descriptor === this.ix_1) {
      var tmp = this.dw();
      var tmp2 = this.uw();
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast' call
      // Inline function 'kotlinx.serialization.json.internal.cast' call
      var serialName = this.ix_1.ae();
  ...
  protoOf(JsonTreeDecoder).xe = function (descriptor) {
    ...
    var strategy = namingStrategy(descriptor, this.dw());
    var tmp_1;
    if (strategy == null && !this.sw_1.mr_1) {
      tmp_1 = jsonCachedSerialNames(descriptor);
    } else if (!(strategy == null)) {
      tmp_1 = deserializationNamesMap(this.dw(), descriptor).t1();
    } else {
      var tmp_2 = jsonCachedSerialNames(descriptor);
      var tmp0_safe_receiver = get_schemaCache(this.dw()).tv(descriptor, get_JsonDeserializationNamesKey());
  ...
  protoOf(JsonTreeListDecoder).vw = function (tag) {
    return this.sx_1.j(toInt(tag));
  };
  protoOf(JsonTreeListDecoder).hf = function (descriptor) {
    while (this.ux_1 < (this.tx_1 - 1 | 0)) {
  ...
  function JsonTreeMapDecoder(json, value) {
    ...
    this.fy_1 = value;
    this.gy_1 = toList(this.fy_1.t1());
    this.hy_1 = imul(this.gy_1.k(), 2);
    this.iy_1 = -1;
  }
  ...
  protoOf(JsonTreeMapDecoder).yj = function (descriptor, index) {
    var i = index / 2 | 0;
    return this.gy_1.j(i);
  };
  protoOf(JsonTreeMapDecoder).hf = function (descriptor) {
    while (this.iy_1 < (this.hy_1 - 1 | 0)) {
      this.iy_1 = this.iy_1 + 1 | 0;
      return this.iy_1;
    }
    return -1;
  };
  protoOf(JsonTreeMapDecoder).vw = function (tag) {
    return (this.iy_1 % 2 | 0) === 0 ? JsonPrimitive_0(tag) : getValue(this.fy_1, tag);
  };
  ...
  function appendEscape($this, lastPosition, current) {
    $this.jy(lastPosition, current);
    return appendEsc($this, current + 1 | 0);
  }
  function decodedString($this, lastPosition, currentPosition) {
    $this.jy(lastPosition, currentPosition);
    var result = $this.gq_1.toString();
    $this.gq_1.j9(0);
    return result;
  }
  function takePeeked($this) {
    // Inline function 'kotlin.also' call
    var this_0 = ensureNotNull($this.fq_1);
    $this.fq_1 = null;
    return this_0;
  }
  function wasUnquotedString($this) {
    return !(charSequenceGet($this.ky(), $this.dq_1 - 1 | 0) === _Char___init__impl__6a9atx(34));
  }
  function appendEsc($this, startPosition) {
    var currentPosition = startPosition;
    currentPosition = $this.ly(currentPosition);
    if (currentPosition === -1) {
      $this.iu('Expected escape sequence to continue, got EOF');
    }
    var tmp = $this.ky();
    ...
    if (currentChar === _Char___init__impl__6a9atx(117)) {
      return appendHex($this, $this.ky(), currentPosition);
    }
    // Inline function 'kotlin.code' call
    var tmp$ret$0 = Char__toInt_impl_vasixd(currentChar);
    var c = escapeToChar(tmp$ret$0);
    if (c === _Char___init__impl__6a9atx(0)) {
      $this.iu("Invalid escaped char '" + toString_1(currentChar) + "'");
    }
    $this.gq_1.k6(c);
  ...
  function appendHex($this, source, startPos) {
    if ((startPos + 4 | 0) >= charSequenceLength(source)) {
      $this.dq_1 = startPos;
      $this.my();
      if (($this.dq_1 + 4 | 0) >= charSequenceLength(source)) {
        $this.iu('Unexpected EOF during unicode escape');
      }
      return appendHex($this, source, $this.dq_1);
    }
    $this.gq_1.k6(numberToChar((((fromHexChar($this, source, startPos) << 12) + (fromHexChar($this, source, startPos + 1 | 0) << 8) | 0) + (fromHexChar($this, source, startPos + 2 | 0) << 4) | 0) + fromHexChar($this, source, startPos + 3 | 0) | 0));
    return startPos + 4 | 0;
  }
  function fromHexChar($this, source, currentPosition) {
    ...
    if (_Char___init__impl__6a9atx(48) <= character ? character <= _Char___init__impl__6a9atx(57) : false) {
      ...
      $this.iu("Invalid toHexChar char '" + toString_1(character) + "' in unicode escape");
    }
    return tmp;
  }
  function consumeBoolean2($this, start) {
    var current = $this.ly(start);
    if (current >= charSequenceLength($this.ky()) || current === -1) {
      $this.iu('EOF');
    }
    var tmp = $this.ky();
    ...
    if (tmp0_subject === Char__toInt_impl_vasixd(this_1)) {
      ...
      if (tmp0_subject === Char__toInt_impl_vasixd(this_2)) {
        ...
        $this.iu("Expected valid boolean literal prefix, but had '" + $this.mu() + "'");
      }
    }
    return tmp_0;
  }
  function consumeBooleanLiteral($this, literalSuffix, current) {
    if ((charSequenceLength($this.ky()) - current | 0) < literalSuffix.length) {
      $this.iu('Unexpected end of boolean literal');
    }
    var inductionVariable = 0;
    ...
    if (inductionVariable <= last)
      do {
        ...
        var actual = charSequenceGet($this.ky(), current + i | 0);
        // Inline function 'kotlin.code' call
       ...
       while (inductionVariable <= last);
    $this.dq_1 = current + literalSuffix.length | 0;
  }
  ...
  function AbstractJsonLexer() {
    this.dq_1 = 0;
    this.eq_1 = new JsonPath();
    this.fq_1 = null;
    this.gq_1 = StringBuilder_init_$Create$();
  }
  protoOf(AbstractJsonLexer).my = function () {
  };
  protoOf(AbstractJsonLexer).wv = function () {
    var current = this.ny();
    var source = this.ky();
  ...
  protoOf(AbstractJsonLexer).oy = function (c) {
    return c === _Char___init__impl__6a9atx(125) || c === _Char___init__impl__6a9atx(93) || (c === _Char___init__impl__6a9atx(58) || c === _Char___init__impl__6a9atx(44)) ? false : true;
  };
  protoOf(AbstractJsonLexer).hq = function () {
    var nextToken = this.ou();
    if (!(nextToken === 10)) {
      this.iu('Expected EOF after parsing, but had ' + toString_1(charSequenceGet(this.ky(), this.dq_1 - 1 | 0)) + ' instead');
    }
  };
  protoOf(AbstractJsonLexer).hu = function (expected) {
    var token = this.ou();
    if (!(token === expected)) {
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.fail' call
      var expected_0 = tokenDescription(expected);
      var position = true ? this.dq_1 - 1 | 0 : this.dq_1;
      var s = this.dq_1 === charSequenceLength(this.ky()) || position < 0 ? 'EOF' : toString_1(charSequenceGet(this.ky(), position));
      var tmp$ret$1 = 'Expected ' + expected_0 + ", but had '" + s + "' instead";
      this.iu(tmp$ret$1, position);
    }
    return token;
  };
  protoOf(AbstractJsonLexer).py = function (expected) {
    if (this.dq_1 > 0 && expected === _Char___init__impl__6a9atx(34)) {
      var tmp$ret$0;
      $l$block: {
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.withPositionRollback' call
        var snapshot = this.dq_1;
        try {
          this.dq_1 = this.dq_1 - 1 | 0;
          tmp$ret$0 = this.mu();
          break $l$block;
      ...
      if (inputLiteral === 'null') {
        this.dt("Expected string literal but 'null' literal was found", this.dq_1 - 1 | 0, "Use 'coerceInputValues = true' in 'Json {}' builder to coerce nulls if property has a default value.");
      }
    }
    // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.fail' call
  ...
  protoOf(AbstractJsonLexer).xv = function (doConsume) {
    var current = this.ny();
    current = this.ly(current);
    var len = charSequenceLength(this.ky()) - current | 0;
    if (len < 4 || current === -1)
      return false;
    var inductionVariable = 0;
    if (inductionVariable <= 3)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (!(charCodeAt('null', i) === charSequenceGet(this.ky(), current + i | 0)))
          return false;
      }
       while (inductionVariable <= 3);
    if (len > 4 && charToTokenClass(charSequenceGet(this.ky(), current + 4 | 0)) === 0)
      return false;
    if (doConsume) {
      this.dq_1 = current + 4 | 0;
    }
    return true;
  };
  protoOf(AbstractJsonLexer).kw = function (doConsume, $super) {
    doConsume = doConsume === VOID ? true : doConsume;
    return $super === VOID ? this.xv(doConsume) : $super.xv.call(this, doConsume);
  };
  protoOf(AbstractJsonLexer).yv = function (isLenient) {
    var token = this.ju();
    var tmp;
    if (isLenient) {
      if (!(token === 1) && !(token === 0))
  ...
  protoOf(AbstractJsonLexer).ry = function (startPos, endPos) {
    // Inline function 'kotlin.text.substring' call
    var this_0 = this.ky();
    return toString(charSequenceSubSequence(this_0, startPos, endPos));
  };
  protoOf(AbstractJsonLexer).lu = function () {
    if (!(this.fq_1 == null)) {
  ...
  protoOf(AbstractJsonLexer).consumeString2 = function (source, startPosition, current) {
    ...
    while (!(char === _Char___init__impl__6a9atx(34))) {
      if (char === _Char___init__impl__6a9atx(92)) {
        usedAppend = true;
        currentPosition = this.ly(appendEscape(this, lastPosition, currentPosition));
        if (currentPosition === -1) {
          this.iu('Unexpected EOF', currentPosition);
        }
    ...
    var tmp;
    if (!usedAppend) {
      tmp = this.ry(lastPosition, currentPosition);
    } else {
      tmp = decodedString(this, lastPosition, currentPosition);
    }
    var string = tmp;
    this.dq_1 = currentPosition + 1 | 0;
    return string;
  };
  protoOf(AbstractJsonLexer).cw = function () {
    var result = this.mu();
    if (result === 'null' && wasUnquotedString(this)) {
      this.iu("Unexpected 'null' value instead of string literal");
    }
    return result;
  };
  protoOf(AbstractJsonLexer).mu = function () {
    if (!(this.fq_1 == null)) {
      return takePeeked(this);
    }
    var current = this.ny();
    ...
    var token = charToTokenClass(charSequenceGet(this.ky(), current));
    if (token === 1) {
      return this.lu();
    }
    if (!(token === 0)) {
      this.iu('Expected beginning of the string, but got ' + toString_1(charSequenceGet(this.ky(), current)));
    }
    var usedAppend = false;
    while (charToTokenClass(charSequenceGet(this.ky(), current)) === 0) {
      current = current + 1 | 0;
      if (current >= charSequenceLength(this.ky())) {
        usedAppend = true;
        this.jy(this.dq_1, current);
        var eof = this.ly(current);
        if (eof === -1) {
          this.dq_1 = current;
    ...
    var tmp;
    if (!usedAppend) {
      tmp = this.ry(this.dq_1, current);
    } else {
      tmp = decodedString(this, this.dq_1, current);
    }
    var result = tmp;
    this.dq_1 = current;
    return result;
  };
  protoOf(AbstractJsonLexer).jy = function (fromIndex, toIndex) {
    this.gq_1.e9(this.ky(), fromIndex, toIndex);
  };
  protoOf(AbstractJsonLexer).aw = function (allowLenientStrings) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var tokenStack = ArrayList_init_$Create$();
    var lastToken = this.ju();
    ...
    $l$loop: while (true) {
      ...
      if (tmp0_subject === 8 || tmp0_subject === 6) {
        ...
        if (!(last(tokenStack) === 8))
          throw JsonDecodingException_0(this.dq_1, 'found ] instead of } at path: ' + this.eq_1.toString(), this.ky());
        ...
        this.iu('Unexpected end of input due to malformed JSON during ignoring unknown keys');
      }
      this.ou();
      if (tokenStack.k() === 0)
        return Unit_instance;
  ...
  protoOf(AbstractJsonLexer).toString = function () {
    return "JsonReader(source='" + toString(this.ky()) + "', currentPosition=" + this.dq_1 + ')';
  };
  protoOf(AbstractJsonLexer).zv = function (key) {
    var processed = this.ry(0, this.dq_1);
    var lastIndexOf_0 = lastIndexOf(processed, key);
    throw new JsonDecodingException("Encountered an unknown key '" + key + "' at offset " + lastIndexOf_0 + ' at path: ' + this.eq_1.qt() + "\nUse 'ignoreUnknownKeys = true' in 'Json {}' builder or '@JsonIgnoreUnknownKeys' annotation to ignore unknown keys.\n" + ('JSON input: ' + toString(minify(this.ky(), lastIndexOf_0))));
  };
  protoOf(AbstractJsonLexer).dt = function (message, position, hint) {
    var tmp;
    ...
    var hintMessage = tmp;
    throw JsonDecodingException_0(position, message + ' at path: ' + this.eq_1.qt() + hintMessage, this.ky());
  };
  protoOf(AbstractJsonLexer).iu = function (message, position, hint, $super) {
    position = position === VOID ? this.dq_1 : position;
    hint = hint === VOID ? '' : hint;
    return $super === VOID ? this.dt(message, position, hint) : $super.dt.call(this, message, position, hint);
  };
  protoOf(AbstractJsonLexer).mw = function () {
    var current = this.ny();
    current = this.ly(current);
    if (current >= charSequenceLength(this.ky()) || current === -1) {
      this.iu('EOF');
    ...
    var tmp;
    if (charSequenceGet(this.ky(), current) === _Char___init__impl__6a9atx(34)) {
      current = current + 1 | 0;
      if (current === charSequenceLength(this.ky())) {
        this.iu('EOF');
      }
    ...
    var start = current;
    $l$loop_4: while (!(current === charSequenceLength(this.ky()))) {
      var ch = charSequenceGet(this.ky(), current);
      if ((ch === _Char___init__impl__6a9atx(101) || ch === _Char___init__impl__6a9atx(69)) && !hasExponent) {
        if (current === start) {
          this.iu('Unexpected symbol ' + toString_1(ch) + ' in numeric literal');
        }
      ...
      if (ch === _Char___init__impl__6a9atx(45) && hasExponent) {
        if (current === start) {
          this.iu("Unexpected symbol '-' in numeric literal");
        }
      ...
      if (compare(accumulator, new Long(0, 0)) > 0) {
        this.iu('Numeric value overflow');
      }
    }
    var hasChars = !(current === start);
    if (start === current || (isNegative && start === (current - 1 | 0))) {
      this.iu('Expected numeric literal');
    }
    if (hasQuotation) {
      if (!hasChars) {
        this.iu('EOF');
      ...
      if (!(charSequenceGet(this.ky(), current) === _Char___init__impl__6a9atx(34))) {
        this.iu('Expected closing quotation mark');
      }
      current = current + 1 | 0;
    }
    this.dq_1 = current;
    if (hasExponent) {
      ...
      if (!(Math.floor(doubleAccumulator) === doubleAccumulator)) {
        this.iu("Can't convert " + doubleAccumulator + ' to Long');
      }
  ...
  protoOf(AbstractJsonLexer).ds = function () {
    var result = this.mw();
    var next = this.ou();
    if (!(next === 10)) {
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.fail' call
  ...
  protoOf(AbstractJsonLexer).lw = function () {
    var current = this.ny();
    if (current === charSequenceLength(this.ky())) {
      this.iu('EOF');
    }
    ...
    if (hasQuotation) {
      if (this.dq_1 === charSequenceLength(this.ky())) {
        this.iu('EOF');
      }
      if (!(charSequenceGet(this.ky(), this.dq_1) === _Char___init__impl__6a9atx(34))) {
        this.iu('Expected closing quotation mark');
      }
      this.dq_1 = this.dq_1 + 1 | 0;
    }
  ...
  function charToTokenClass(c) {
    ...
    if (Char__toInt_impl_vasixd(c) < 126) {
      var tmp_0 = CharMappings_getInstance().ty_1;
      // Inline function 'kotlin.code' call
  ...
  function escapeToChar(c) {
    return c < 117 ? CharMappings_getInstance().sy_1[c] : _Char___init__impl__6a9atx(0);
  }
  ...
  function initC2ESC($this, c, esc) {
    if (!(esc === _Char___init__impl__6a9atx(117))) {
      ...
      $this.sy_1[tmp$ret$0] = numberToChar(c);
    }
  }
  ...
  function CharMappings() {
    ...
    this.sy_1 = charArray(117);
    this.ty_1 = new Int8Array(126);
    initEscape(this);
  ...
  protoOf(StringJsonLexerWithComments).ou = function () {
    var source = this.ky();
    var cpos = this.ny();
  ...
  protoOf(StringJsonLexerWithComments).ku = function () {
    var current = this.ny();
    if (current >= this.ky().length || current === -1)
      return false;
    return this.oy(charCodeAt(this.ky(), current));
  };
  protoOf(StringJsonLexerWithComments).vv = function (expected) {
    var source = this.ky();
    var current = this.ny();
  ...
  protoOf(StringJsonLexerWithComments).ju = function () {
    var source = this.ky();
    var cpos = this.ny();
    if (cpos >= source.length || cpos === -1)
      return 10;
  ...
  protoOf(StringJsonLexerWithComments).ny = function () {
    var current = this.dq_1;
    if (current === -1)
      return current;
    var source = this.ky();
    $l$loop_1: while (current < source.length) {
      ...
      if (c === _Char___init__impl__6a9atx(47) && (current + 1 | 0) < source.length) {
        ...
        if (tmp0_subject === _Char___init__impl__6a9atx(47)) {
          ...
          if (current === -1) {
            this.dq_1 = source.length;
            this.iu('Expected end of the block comment: "*/", but had EOF instead');
          } else {
            current = current + 2 | 0;
          }
          continue $l$loop_1;
  ...
  protoOf(StringJsonLexer).ly = function (position) {
    return position < this.ky().length ? position : -1;
  };
  protoOf(StringJsonLexer).ou = function () {
    var source = this.ky();
    var cpos = this.dq_1;
  ...
  protoOf(StringJsonLexer).ku = function () {
    var current = this.dq_1;
    if (current === -1)
      return false;
    var source = this.ky();
  ...
  protoOf(StringJsonLexer).ny = function () {
    var current = this.dq_1;
    if (current === -1)
      return current;
    var source = this.ky();
  ...
  protoOf(StringJsonLexer).vv = function (expected) {
    if (this.dq_1 === -1) {
      this.py(expected);
    }
    var source = this.ky();
  ...
  protoOf(StringJsonLexer).bw = function () {
    this.vv(_Char___init__impl__6a9atx(34));
    var current = this.dq_1;
    var closingQuote = indexOf_0(this.ky(), _Char___init__impl__6a9atx(34), current);
    if (closingQuote === -1) {
      this.mu();
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonLexer.fail' call
      var expected = tokenDescription(1);
      var position = false ? this.dq_1 - 1 | 0 : this.dq_1;
      var s = this.dq_1 === charSequenceLength(this.ky()) || position < 0 ? 'EOF' : toString_1(charSequenceGet(this.ky(), position));
    ...
    if (inductionVariable < closingQuote)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (charCodeAt(this.ky(), i) === _Char___init__impl__6a9atx(92)) {
          return this.consumeString2(this.ky(), this.dq_1, i);
        }
      }
       while (inductionVariable < closingQuote);
    this.dq_1 = closingQuote + 1 | 0;
    return substring(this.ky(), current, closingQuote);
  };
  protoOf(StringJsonLexer).fw = function (keyToMatch, isLenient) {
    var positionSnapshot = this.dq_1;
    try {
      if (!(this.ou() === 6))
        return null;
      var firstKey = this.yv(isLenient);
      if (!(firstKey === keyToMatch))
        return null;
      this.qy();
      if (!(this.ou() === 5))
        return null;
      return this.yv(isLenient);
    }finally {
      this.dq_1 = positionSnapshot;
      this.qy();
    }
  };
  function StringJsonLexer_0(json, source) {
    return !json.op_1.qr_1 ? new StringJsonLexer(source) : new StringJsonLexerWithComments(source);
  }
  function get_schemaCache(_this__u8e3s4) {
    return _this__u8e3s4.qp_1;
  }
  function JsonToStringWriter() {
    this.tp_1 = StringBuilder_init_$Create$_0(128);
  }
  protoOf(JsonToStringWriter).qs = function (value) {
    this.tp_1.i9(value);
  };
  protoOf(JsonToStringWriter).ms = function (char) {
    this.tp_1.k6(char);
  };
  protoOf(JsonToStringWriter).os = function (text) {
    this.tp_1.j6(text);
  };
  protoOf(JsonToStringWriter).us = function (text) {
    printQuoted(this.tp_1, text);
  };
  protoOf(JsonToStringWriter).up = function () {
    this.tp_1.k9();
  };
  protoOf(JsonToStringWriter).toString = function () {
    return this.tp_1.toString();
  };
